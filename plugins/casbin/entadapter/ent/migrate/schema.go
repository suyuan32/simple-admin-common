...
var (
	...
	CasbinRulesColumns = []*schema.Column{
		...
		{Name: "ptype", Type: field.TypeString, Size: 24, Default: ""},
		{Name: "v0", Type: field.TypeString, Size: 24, Default: ""},
		{Name: "v1", Type: field.TypeString, Default: ""},
		{Name: "v2", Type: field.TypeString, Size: 24, Default: ""},
		{Name: "v3", Type: field.TypeString, Size: 32, Default: ""},
		{Name: "v4", Type: field.TypeString, Size: 12, Default: ""},
		{Name: "v5", Type: field.TypeString, Size: 12, Default: ""},
	}
