...
import (
	...
	"github.com/suyuan32/simple-admin-common/plugins/casbin/entadapter/ent"
	"github.com/suyuan32/simple-admin-common/plugins/casbin/entadapter/ent/casbinrule"
	"github.com/suyuan32/simple-admin-common/plugins/casbin/entadapter/ent/predicate"
...
func (a *Adapter) WithTx(fn func(tx *ent.Tx) error) error {
	...
	if err := tx.Commit(); err != nil {
		return errors.Join(err, fmt.Errorf("committing transaction: %v", err))
	}
	return nil
}
